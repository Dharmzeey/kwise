      ...
      <div className="rounded p-4 px-3 border border-border-color">
        ...
        <div className="flex justify-between">
          ...
          <div className="flex gap-3">
            <SocialIcon url="https://x.com/Dharmzeey" bgColor="black" />
            <SocialIcon url="https://www.instagram.com/dharmzeey/" bgColor="black" />
            <SocialIcon url="hhttps://web.facebook.com/profile.php?id=100008304151354" bgColor="black" />
          </div>
        </div>
      </div>
    </footer>
