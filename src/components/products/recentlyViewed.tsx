...
import { RECENTLY_VIEWED_URL } from "@/utils/urls";
...
useEffect(()=>{
    ...
    let viewedProducts: string[] = existingViewed ? JSON.parse(existingViewed) : [];
            ...
            <>
                {
                    products.length > 0 &&
                    <div>
                        <h3 className="text-lg font-semibold my-4">Recently Viewed Products</h3>
